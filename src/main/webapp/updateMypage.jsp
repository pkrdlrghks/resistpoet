    ...
    <div class="container col-4 mt-5 mb-5 bg-light pb-3 pt-3 rounded">
      ...
      <form action="updateMyServlet" method="post" name="sinDater">
        ...
        <div class="input-group">
          <input type="text" name="id" class="form-control" value='<%=request.getParameter("id").toString()%>' readonly>
        </div>
        <div class="row">
        ...
        <div class="row">
          <label for="pwdCheck" class="col-form-label">비밀번호 확인</label>
        </div>
        <div class="input-group">
        ...
        <div class="input-group">
          <input type="text" class="form-control" name="name" value='<%=request.getParameter("name").toString()%>' required>
        </div>
        <div class="row">
          <label for="inputPassword6" class="col-form-label">전화 번호</label>
        </div>
        <div class="input-group">
          <input type="tel" class="form-control" name="tel" value='<%=request.getParameter("tel").toString()%>' required>
        </div>
        <div class="row">
